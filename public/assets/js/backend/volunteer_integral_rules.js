define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'volunteer_integral_rules/index' + location.search,
                    add_url: 'volunteer_integral_rules/add',
                    edit_url: 'volunteer_integral_rules/edit',
                    del_url: 'volunteer_integral_rules/del',
                    multi_url: 'volunteer_integral_rules/multi',
                    table: 'volunteer_integral_rules',
                }
            });
