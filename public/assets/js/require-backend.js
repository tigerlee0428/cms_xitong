require.config({
    ...
    paths: {
        ...
        //treegid
        'bootstrap-table-1.15.4': '../libs/bootstrap-table-1.15.4/dist/bootstrap-table',
        'bootstrap-table-treegrid-1.15.4':'../libs/bootstrap-table-1.15.4/dist/extensions/treegrid/bootstrap-table-treegrid',
        'jquery-treegrid':'../libs/jquery-treegrid/js/jquery.treegrid',
...
//                'css!../libs/bootstrap-table/dist/bootstrap-table.min.css'
        ...
        'bootstrap-table-treegrid-1.15.4': {
            deps: ['bootstrap-table-1.15.4','jquery-treegrid'],
