...
class Admin extends Backend
{
    ...
    public function _initialize()
    {
        ...
        //取出所有自己的区域，包涵自己
        $areaList = collection(Area::where([])->field("id,pid,name")->select())->toArray();
        Tree::instance()->init($areaList);
        $areaResult = Tree::instance()->getTreeList(Tree::instance()->getTreeArray($this->auth->area_id));
        $areaData[$this->auth->area_id] = Area::where(['id'=>$this->auth->area_id])->value('name');
    ...
    public function edit($ids = NULL)
    {
        ...
        $this->view->assign("areaid", $row->area_id);
        return $this->view->fetch();
    }
