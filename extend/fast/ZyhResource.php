...
class ZyhResource
{
	 ...
	 * 获取服务器数据数据
	 */
	public static function  getData($apiFun='', $apiParam=array(), $accessKeyId='', $accessKeySecret=''){
	    $apiUrl =  "http://47.99.112.147:8080/VMSAPI/";
		$accessKeyId = 'f1969cdde5434d71bca7813acafd0956';
		$accessKeySecret = 'cbf7ef4fd1e64f5b876cc2943843b71f';
    ...
    public static function  getqrData($apiFun='', $apiParam=array(), $accessKeyId='', $accessKeySecret=''){
        $apiUrl =  "http://47.99.112.147:8080/xsdwmsj";
        $accessKeyId = 'f1969cdde5434d71bca7813acafd0956';
        $accessKeySecret = 'cbf7ef4fd1e64f5b876cc2943843b71f';
        $client_url = $apiUrl.$apiFun.'.do';
        $data = self::getapiByarr($apiParam,$accessKeyId, $accessKeySecret);
